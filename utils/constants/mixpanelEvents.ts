...
export const BUY_ITEM_IN_POI_SHOP_MIXPANEL_EVENT_HASH = convertToBytes32('Buy Item in POI Shop');
export const POINTS_EARNED_IN_POI_SHOP_MIXPANEL_EVENT_HASH = convertToBytes32('Points Earned in POI Shop');
