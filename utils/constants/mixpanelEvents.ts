...
export const DELEGATE_SQUAD_LEADER_EVENT_HASH = convertToBytes32('Delegate Leadership');
export const ADD_SQUAD_CO_LEADER_EVENT_HASH = convertToBytes32('Add Co-Leader');
export const DEMOTE_SQUAD_CO_LEADER_EVENT_HASH = convertToBytes32('Demote Co-Leader');
