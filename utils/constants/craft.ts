import { CarpentingCraft, CookingCraft, CraftItem, CraftItemLine, CraftItemRarity, CraftResultItem, CraftType, SmeltingCraft, TailoringCraft } from "../../models/craft";
...
export const craftResultItems : CraftResultItem[] = 
[
    //Smelting crafts
    { 
        type: SmeltingCraft.PURIFIED_STONE, 
    ...
    { 
        ...
        catalyst:
        [
            {type: FruitResource.TOMATO, amount:20}, 
            {type: FruitResource.STAR_FRUIT, amount:20},
            {type: FruitResource.APPLE, amount:20} 
        ], 
        baseSuccessChance: 70, baseCritChance: 0, points: 25, craftPoints: 15, berries: 0.01
        ,reqLevel: 1, reqCraftLevel: 1, craftExp: 10, weight: 1
    },
