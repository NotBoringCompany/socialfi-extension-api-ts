...
export const SMELTING_MASTERY_LEVEL = (totalExp: number): number => {
  if (totalExp >= 0 && totalExp <= 4999) {
    return 1;
  } else if (totalExp >= 5000 && totalExp <= 12499) {
    return 2;
...
export const COOKING_MASTERY_LEVEL = (totalExp: number): number => {
  if (totalExp >= 0 && totalExp <= 4999) {
    return 1;
  } else if (totalExp >= 5000 && totalExp <= 12499) {
    return 2;
...
export const CARPENTING_MASTERY_LEVEL = (totalExp: number): number => {
  if (totalExp >= 0 && totalExp <= 4999) {
    return 1;
  } else if (totalExp >= 5000 && totalExp <= 12499) {
    return 2;
...
export const TAILORING_MASTERY_LEVEL = (totalExp: number): number => {
  if (totalExp >= 0 && totalExp <= 4999) {
    return 1;
  } else if (totalExp >= 5000 && totalExp <= 12499) {
    return 2;
