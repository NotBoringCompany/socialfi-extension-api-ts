 ...
 * 
 * NOTE: the current gathering rates will NOT be added here due to complexity, but is available in `calcBitCurrentRate`.
 */
...
/**
 * Reductions in gathering rate rate when the bit's energy is lower than a certain amount.
 */
