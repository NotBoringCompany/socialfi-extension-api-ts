...
router.post('/claim_crafted_assets', async (req, res) => {
    ...
    try {
        ...
        if (status === Status.SUCCESS) {
            ...
            const craftingResult: { queueId: string, craftedAsset: string, claimAmount: number }[] = [...fullyClaimedCraftingData, ...partiallyClaimedCraftingData];
            ...
            const craftedTotal = craftingResult
                ...
                .reduce((prev, curr) => prev + curr.claimAmount, 0);
