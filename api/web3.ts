...
import { BINANCE_API_BASE_URL, DEPLOYER_WALLET, GATEIO_API_BASE_URL, KUCOIN_API_BASE_URL, TON_RECEIVER_ADDRESS, TON_WEB, USER_WALLET, WONDERBITS_CONTRACT, WONDERBITS_CONTRACT_USER, XPROTOCOL_TESTNET_PROVIDER } from '../utils/constants/web3';
